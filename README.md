...
[针对Webpack等前端打包工具构造的网站进行快速、高效安全检测的扫描工具](https://github.com/rtcatc/Packer-Fuzzer)

[天眼查信息收集工具](https://github.com/canc3s/cSubsidiary)

[Kscan - 简单好用的资产测绘工具](https://github.com/lcvvvv/kscan)

[Search-Tools 集合比较常见的网络空间探测引擎](https://github.com/atdpa4sw0rd/Search-Tools)

[gitrecon 从Github和Gitlab配置文件中提取信息,查找泄露的用户邮件地址](https://github.com/GONZOsint/gitrecon)

[TXPortMap 实用型免费渗透测试工具](https://github.com/4dogs-cn/TXPortMap)

[PortBrute 一款跨平台小巧的端口爆破工具](https://github.com/awake1t/PortBrute)

[Scanners Box也被称为 scanbox，是一个强大完备的黑客工具箱](https://github.com/We5ter/Scanners-Box/blob/master/README_CN.md)

[maigret 用户名收集工具,从大量站点中收集用户个人信息](https://github.com/soxoj/maigret)

[Golang实现Wappalyzer 指纹识别](https://github.com/projectdiscovery/wappalyzergo)

[remote-method-guesser Java RMI漏洞扫描程序](https://github.com/qtc-de/remote-method-guesser)

[dnsub一款好用的子域名扫描工具](https://github.com/yunxu1/dnsub)
...
[巡风是一款适用于企业内网的漏洞快速应急、巡航扫描系统](https://github.com/ysrc/xunfeng)

[Vulmap 是一款 web 漏洞扫描和验证工具](https://github.com/zhzyker/vulmap)

[Perun 网络资产漏洞扫描器/扫描框架](https://github.com/WyAtu/Perun)

[fscan 一款内网扫描工具，方便一键大保健~](https://github.com/shadow1ng/fscan)

[w9scan 一款全能型的网站漏洞扫描器](https://github.com/w-digital-scanner/w9scan)

[POC-T 渗透测试插件化并发框架](https://github.com/Xyntax/POC-T)

[SNETCracker 超级弱口令检查工具](https://github.com/shack2/SNETCracker)

[DongTaiDoc 灵芝IAST是一款交互式应用安全评估工具](https://github.com/HXSecurity/DongTaiDoc)

[linglong 一款甲方资产巡航扫描系统。系统定位是发现资产，进行端口爆破](https://github.com/awake1t/linglong)
...
[frp 专注于内网穿透的高性能的反向代理应用](https://github.com/fatedier/frp)

[nps 轻量级、高性能、功能强大的内网穿透代理服务器](https://github.com/ehang-io/nps)

[iox 端口转发 & 内网代理工具](https://github.com/EddieIvan01/iox)
...
[dns2tcp是一款利用dns协议传输tcp数据的工具](https://github.com/alex-sector/dns2tcp)

[dnscat2 是一个DNS隧道工具](https://github.com/iagox86/dnscat2)

[ABPTTS 基于ssl加密的http隧道工具](https://github.com/nccgroup/ABPTTS)

[Termite 内网渗透代理、端口转发工具](http://rootkiter.com/Termite/)

[SSTap, 一款利用虚拟网卡在网络层实现的代理工具](https://github.com/FQrabbit/SSTap-Rule)

[ew 用于开启 SOCKS v5 代理服务的工具(跨平台)](https://github.com/idlefire/ew)

[n2n 开源的点对点穿透工具](https://github.com/ntop/n2n)

[icmpsh 一个简单的 reverse ICMP shell](https://github.com/inquisb/icmpsh)

[ngrok 正/反向代理，内网穿透，端口转发](https://github.com/inconshreveable/ngrok)

[ssf 全平台的加密隧道 端口转发工具](https://securesocketfunneling.github.io/ssf/)

[proxychains 命令行代理神器](https://github.com/haad/proxychains)

[switcher 一个多功能的端口转发/端口复用工具](https://github.com/crabkun/switcher)

[pingtunnel 是把 tcp/udp/sock5 流量伪装成 icmp 流量进行转发的工具](https://github.com/esrrhs/pingtunnel)

[chisel - 一款快速稳定的隧道工具](https://github.com/jpillora/chisel)

[pystinger - 一款使用webshell进行流量转发的出网工具](https://github.com/FunnyWolf/pystinger)

[pivotnacci - 通过HTTP代理建立socks连接的工具](https://github.com/blackarrowsec/pivotnacci)
...
[Empire 基于 poweshell 的命令执行框架 后渗透利器](https://github.com/EmpireProject/Empire)
...
[wesng - Windows利用程序辅助工具](https://github.com/bitsadmin/wesng)

[Viper - metasploit-framework 图形化内网渗透工具](https://github.com/FunnyWolf/Viper)

[WebshellManager w8ay 一句话WEB端管理工具](https://github.com/boy-hack/WebshellManager)
...
[PCredz 从pcap文件或实时界面中提取敏感信息](https://github.com/lgandx/PCredz)
...
[梼杌 cobalt strike3.x与cobalt strike4.x的插件](https://github.com/pandasec888/taowu-cobalt-strike)
...
[Cobalt Strike随机C2配置文件生成器](https://github.com/threatexpress/random_c2_profile)

[Cobalt Strike 上线提醒](https://github.com/kingz40o/Aggressor_dingding)

[FOFA Pro view 是一款FOFA Pro 资产展示浏览器插件](https://github.com/fofapro/fofa_view)

## 历史漏洞库,最新漏洞PoC/Exp,快速检索。

[棱角社区不定期复现的一些漏洞](https://github.com/EdgeSecurityTeam/Vulnerability)
...
[Pwnwiki是一个免费、自由、人人可编辑的漏洞库](https://www.pwnwiki.org/index.php?title=Main_Page)

[cvebase 最新的CVE漏洞利用活动](https://www.cvebase.com/poc)

[AttackerKB 免费的众筹漏洞评估知识库](https://attackerkb.com/)

[阿里云安全公告/最新漏洞预警](https://help.aliyun.com/noticelist/9213612.html)

[华安云 漏洞情报平台](https://vti.huaun.com/index/)

[vx-underground 漏洞库](https://vxug.fakedoma.in/tmp/Exploits/)
...
[红队笔记 ired.team](https://www.ired.team/)
...
[WhITECat公开知识积累](https://www.yuque.com/whitecatanquantuandui/xkx7k2)

[渗透测试有关的POC、EXP、脚本、提权、小工具等](https://github.com/Mr-xn/Penetration_Testing_POC)

[Cobalt Strike的相关资源汇总](https://github.com/zer0yu/Awesome-CobaltStrike)

[windows 计划任务隐藏新姿势分享](https://paper.seebug.org/1464/)

[Red Team Notes 2.0 红队笔记](https://dmcxblue.gitbook.io/red-team-notes-2-0/)

[XSS Payload速查表](https://github.com/dubey-amit/cheatsheet/blob/master/XSS.MD)

[与SSRF相关的文章、备忘录、视频、书籍的合集](https://github.com/jdonsec/AllThingsSSRF)

[Cobalt-Strike 相关的一些工具以及使用 Tips](https://github.com/S1ckB0y1337/Cobalt-Strike-CheatSheet)

[OSINT Tools & Resources](https://start.me/p/DPYPMz/the-ultimate-osint-collection)

[List of bug bounty writeups](https://pentester.land/list-of-bug-bounty-writeups.html)

[SpringBoot 相关漏洞学习资料，利用方法和技巧合集](https://github.com/LandGrey/SpringBootVulExploit)

[CORS Tips和利用代码](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CORS Misconfiguration)

[关于网络安全相关的RSS订阅](https://github.com/zer0yu/CyberSecurityRSS)

 [红队作战的一些技巧与Tips](https://github.com/mantvydasb/RedTeam-Tactics-and-Techniques)

[一些赏金技巧,包括Bypass技巧,Payload等等..](https://github.com/daffainfo/AllAboutBugBounty)

[BugBountyHunting 搜索引擎](https://www.bugbountyhunting.com/)

[一些渗透姿势记录](https://github.com/safe6Sec/PentestNote)

[一些关于OSCP的知识](https://oscp.infosecsanyam.in/)

[备忘单：2021年可用的XSS Payload](https://netsec.expert/posts/xss-in-2021/)

[SMTP开放中继攻击](https://github.com/harsh-bothra/learn365/blob/main/days/day43.md)

[高质量安全文章](https://github.com/tom0li/collection-document)

[APT攻击与防御 - micro8](https://micro8.gitbook.io/micro8/)

[安全的一些项目/资料](https://github.com/YinWC/Security_Learning)

[安全开发的API 清单](https://github.com/shieldfy/API-Security-Checklist)

[内网渗透TIPS](https://github.com/Ridter/Intranet_Penetration_Tips)

[Hacking the Cloud 攻击性/战术/技术百科全书](https://hackingthe.cloud/)

[1earn 个人维护的安全知识框架](https://github.com/No-Github/1earn)

[攻防对抗 · 蓝队清单，中文版](https://github.com/satan1a/awesome-cybersecurity-blueteam-cn)

[浏览器的一些逻辑漏洞/CVE/文章](https://github.com/Metnew/uxss-db)

[免费的全面逆向工程课程](https://github.com/mytechnotalent/Reverse-Engineering-Tutorial)

[一些网络空间搜索引擎相关的资料](https://github.com/EXHades/CyberSpaceSearchEngine-Research)

[Pentest-Tools 渗透测试工具收集](https://github.com/S3cur3Th1sSh1t/Pentest-Tools)

[有关漏洞赏金狩猎和Web应用程序安全性的Tips](https://github.com/HolyBugx/HolyTips)

[红蓝对抗以及护网相关工具和资料](https://github.com/Mr-xn/RedTeam_BlueTeam_HW)

[一些实用单行命令 有关漏洞赏金的技巧](https://github.com/dwisiswant0/awesome-oneliner-bugbounty)

[TOP25 的一些漏洞参数](https://github.com/lutfumertceylan/top25-parameter)

[错误赏金猎人Pyload，tricks Checklist。](https://github.com/EdOverflow/bugbounty-cheatsheet)

[有关漏洞挖掘时需要做的工作的教程。](https://kathan19.gitbook.io/howtohunt/)
...
[GScan 主机侧Checklist的自动全面化检测脚本](https://github.com/grayddq/GScan)
...
![https://github.com/shuaxingzi/Never_Stop_Learning/blob/main/images/wx.jpg]()
